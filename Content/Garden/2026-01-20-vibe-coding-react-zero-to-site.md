...
리액트를 한 줄도 몰랐지만,\
그냥 “마크다운으로 블로그 만들고 싶다”는 욕심 하나로 시작했다.\
...
23줄짜리 `oh-my-opencode.json`만 정의했다.\
...
“마크다운 블로그 만들고 싶다” 정도로 말했더니 흐릿하게 돌다 멈췄다.\
...
프론트엔드 지식이 없어도 **명확한 디렉션**만 있다면 결과물을 뽑아낼 수 있다는 걸 확인했다.\
하지만 프로덕션급 퀄리티를 내려면, 최소한의 언어와 맥락을 아는 사람이 **품질을 통제**해야 한다.\
