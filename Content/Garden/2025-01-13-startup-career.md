...
AI를 활용한 개발 속도는 이제 **말도 안 되는 수준**이다.

- 예전에는 *1.5인분*만 해도 잘한다고 평가받았다면
- 이제는 **10인분을 기대받는 시대**가 되었다

대 프롬프팅의 시대다.

Claude, Cursor, Codex 같은 도구에  
Rule을 잘 설정하고, 프로젝트를 적절히 분리하고,  
페르소나를 명확히 주입하면 **혼자서도 충분히 1인분 이상의 결과물**이 나온다.
...
하지만 역설적으로, **성장의 밀도는 오히려 낮아질 수 있다**고 느낀다.
...
- 유저 수가 많은 서비스라면  
  → 하루, 어쩌면 30분 이내로 A/B 테스트 결과가 나온다
- 유저 수가 적은 서비스라면  
  → 일주일 이상을 기다려야 할 수도 있다
...
“열심히 코딩하는 개발자”보다  
**완성도 있는 딸깍맨**이 되는 것이 더 현실적인 전략일지도 모르겠다.
